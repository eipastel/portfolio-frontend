  ...
  return (
    <section id="contact" className="py-12 sm:py-16 md:py-24">
      ...
      >
        ...
        <a href="https://www.linkedin.com/in/thiago-diogo/" target="_blank" rel="noopener noreferrer" className="cursor-pointer bg-primary text-primary-foreground px-6 sm:px-8 py-3 sm:py-4 rounded-full font-medium inline-flex items-center gap-2 hover:bg-primary/90 transition-transform hover:scale-105 active:scale-95 relative z-10 text-sm sm:text-base">
          {t("cta")}
